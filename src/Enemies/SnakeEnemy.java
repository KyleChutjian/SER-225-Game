...
// This class is for the snake enemy and is essentially a copy of the bug enemy class
public class SnakeEnemy extends Enemy {
    ...
    public SnakeEnemy(Point location, Direction facingDirection) {
        super(location.x, location.y, new SpriteSheet(ImageLoader.load("Snake.png"), 16, 15), "WALK_LEFT");
    ...
    public void update(Player player) {
        ...
        // add gravity (if in air, this will cause snake to fall)
        moveAmountY += gravity;
    ...
    public void onEndCollisionCheckX(boolean hasCollided, Direction direction) {
        // if snake has collided into something while walking forward,
    ...
    public void onEndCollisionCheckY(boolean hasCollided, Direction direction) {
        // if snake is colliding with the ground, change its air ground state to GROUND
