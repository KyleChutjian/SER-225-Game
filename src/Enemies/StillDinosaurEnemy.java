...
public class StillDinosaurEnemy extends Enemy {
    ...
    public StillDinosaurEnemy(Point startLocation, Point endLocation, Direction facingDirection) {
    ...
    public void initialize() {
        super.initialize();
        super.setEnemyType("STILL_DINOSAUR");
    ...
    public void update(Player player) {
        ...
        if (isActive) {
            ...
            currentAnimationName = "INVISIBLE";
            super.update(player);
            if (isActive) {
    ...
    public HashMap<String, Frame[]> getAnimations(SpriteSheet spriteSheet) {
        return new HashMap<String, Frame[]>() {{
            ...
            put("INVISIBLE", new Frame[]{
                    new FrameBuilder(spriteSheet.getSprite(1, 1), 0)
                            .withScale(3)
                            .withBounds(4, 2, 5, 13)
                            .build(),
            });
