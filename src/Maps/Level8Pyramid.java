...
public class Level8Pyramid extends Map {
    ...
    public ArrayList<Enemy> loadEnemies() {
        ...
        enemies.add(new SnakeEnemy(getPositionByTileIndex(137, 31), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(98, 10), Direction.LEFT));
        ...
        enemies.add(new SnakeEnemy(getPositionByTileIndex(99, 3), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(141, 31), Direction.LEFT));
        enemies.add(new BugEnemy(getPositionByTileIndex(140, 31), Direction.RIGHT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(116, 10), Direction.LEFT));
        ...
        enemies.add(new SnakeEnemy(getPositionByTileIndex(120, 47), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(133, 10), Direction.RIGHT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(105, 41), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(137, 10), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(107, 41), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(137, 19), Direction.RIGHT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(66, 32), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(110, 41), Direction.RIGHT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(54, 41), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(62, 34), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(57, 41), Direction.LEFT));
        enemies.add(new BugEnemy(getPositionByTileIndex(42, 48), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(37, 48), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(50, 48), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(100, 27), Direction.RIGHT));
        enemies.add(new BugEnemy(getPositionByTileIndex(111, 27), Direction.RIGHT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(105, 27), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(93, 27), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(87, 27), Direction.LEFT));
        enemies.add(new SnakeEnemy(getPositionByTileIndex(59, 25), Direction.LEFT));
