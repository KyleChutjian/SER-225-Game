...
public class Level2FieldsScreen extends Screen implements PlayerListener {
    ...
    protected Level2LoseScreen levelLoseScreen;
    protected boolean isGamePaused;
    protected Level2PauseScreen pauseLevelScreen;
    protected long startTime;
    protected long pauseTime;
    protected KeyLocker keyLocker;


    public Level2FieldsScreen(ScreenCoordinator screenCoordinator) {
    ...
    public void initialize() {
        ...
        this.pauseLevelScreen = new Level2PauseScreen(screenCoordinator, this);
    ...
    public void update() {
        ...
        switch (playLevelScreenState) {
            ...
            case PLAYER_DEAD:
                audio.stopPlaying(0);
                levelLoseScreen = new Level2LoseScreen(this);
