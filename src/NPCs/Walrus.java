...
public class Walrus extends NPC {
    ...
    protected SpriteFont createMessage() {
        return new SpriteFont("Hey, I think home is that way!", getX(), getY() - 10, "Arial", 12, Color.BLACK);
    }
    ...
    public void drawMessage(GraphicsHandler graphicsHandler) {
        ...
        graphicsHandler.drawFilledRectangleWithBorder(Math.round(getCalibratedXLocation() - 2), Math.round(getCalibratedYLocation() - 24), 170, 25, Color.WHITE, Color.BLACK, 2);
